    ...
    <div className='container' style={{margin:"auto"}}>
     <div className='row'>
      <div className='col-12'>
        <center>
           <h1>Tp3_react</h1>
              <input type="button" value="+  Ajout" style={{display:!actione?"":"none"}} className='btn btn-danger col-9' onClick={actiont} />
                 <br />
                          ...
                          <div key={i} className='col-9'  style={{backgroundColor:"white",height:"45px",marginBottom:"10px", marginTop:"10px",borderRadius:"10px" }}>
                            <span style={{display:"flex",justifyContent:"start",marginLeft:"12px"}}>
                              <div className='col-1'>
                               ...
                               <h6  style={{display:"flex",justifyContent:"start",textDecoration:el.style?"line-through":"",marginTop:"9px"}} onClick={()=>styles(el.id)} className='col-10'>{el.tach}</h6>
